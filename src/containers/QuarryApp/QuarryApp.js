      ...
      <div className="quarry-app-container">
        ...
        <form className="employment-authorization-quarry">
          ...
          <p>
            ...
            to the best of my knowledge and understand that, if employed,
            falisified statements on this application shall be grounds for
            dismissal. I authorize investigation of all statements contained
            herein and the references and employers listed above to give you any
            and all information concerning my previous employment and any
            pertinent information they may habe, person or otherwise, and
            release the company from all liability for any damage that may
            result from utilization of such information. I also understand and
            agree that no representative of the company has any authority to
            ...
            This waiver does not permit release or use of disability-related or
          ...
          <div className="submit-container">
            <button className="quarry-submit">Submit Application</button>
          </div>
        </form>
      </div>
    );
